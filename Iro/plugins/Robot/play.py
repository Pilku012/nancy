...
from Iro import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Iro.core.call import Iro
from Iro.utils import seconds_to_min, time_to_seconds
from Iro.utils.channelplay import get_channeplayCB
from Iro.utils.database import is_video_allowed
from Iro.utils.decorators.language import languageCB
from Iro.utils.decorators.play import PlayWrapper
from Iro.utils.formatters import formats
from Iro.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Iro.utils.inline.playlist import botplaylist_markup
from Iro.utils.logger import play_logs
from Iro.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("iro_pikku") & ~BANNED_USERS
)
async def Pikku_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "ʏᴏᴜ'ʀᴇ ᴀɴ Pikku ᴀᴅᴍɪɴ\n\nʀᴇᴠᴇʀᴛ ʙᴀᴄᴋ ᴛᴏ ᴜsᴇʀ ᴀᴄᴄᴏᴜɴᴛ ғᴏʀ ᴜsɪɴɢ ᴍᴇ.",
            show_alert=True,
        )
    except:
        return
...
@app.on_callback_query(
    filters.regex("IroPlaylists") & ~BANNED_USERS
)
@languageCB
