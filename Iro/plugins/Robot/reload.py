...
from Iro.utils.database import get_authuser_names, get_cmode
from Iro.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Iro.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Iro.stop_stream(message.chat.id)
    except:
        pass
